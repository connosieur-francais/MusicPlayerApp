...
public class MusicPlaylistDialog extends JDialog{
	...
	private void addDialogComponents() {
		...
		addSongButton.setFont(Constants.DIALOG_BUTTON_FONT);
		addSongButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result == JFileChooser.APPROVE_OPTION && selectedFile != null) {
					...
					filePathLabel.setFont(Constants.FILE_PATH_FONT);
					filePathLabel.setBorder(BorderFactory.createLineBorder(Constants.FILE_PATH_BORDER_COLOR));
		...
		savePlaylistButton.setFont(Constants.DIALOG_BUTTON_FONT);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(result == JFileChooser.APPROVE_OPTION) {
						...
						// create the new file at the desired directory
